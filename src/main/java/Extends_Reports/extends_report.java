...
public class extends_report {
	...
	ExtentSparkReporter spark=new ExtentSparkReporter("ExtendsReporter.html");
	@Test
	  public void f1()
	  {
	  ExtentTest test=extent.createTest("Open Browser").assignAuthor("Sandhya")
	  ...
	  public void f2()
	  {
	   ExtentTest test=extent.createTest("Login to App").assignAuthor("Santosh")
	  ...
	  public void f3()
	  {
	   ExtentTest test=extent.createTest("Verify UserID").assignAuthor("Sandip")
	  ...
	  public void f4()
	  {
	   ExtentTest test=extent.createTest("Logout from App").assignAuthor("Vishranti")
	  ...
	  public void f5()
	  {
	   ExtentTest test=extent.createTest("Close Browser").assignAuthor("Sheetal")
